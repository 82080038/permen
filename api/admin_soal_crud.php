...
if ($action === 'add_soal') {
    ...
    echo json_encode(['success' => true, 'message' => 'Soal berhasil ditambahkan', 'soal_id' => $soalId]);
    ...
    echo json_encode(['success' => true, 'message' => 'Soal berhasil dihapus (soft delete)']);
    ...
    echo json_encode(['success' => true, 'message' => 'Versi berhasil direstore']);
    ...
    echo json_encode(['success' => true, 'diff' => $diff, 'version1' => $v1, 'version2' => $v2]);
