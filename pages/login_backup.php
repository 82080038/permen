...
<link rel="stylesheet" href="<?php echo $baseUrl ?? '/permen'; ?>/assets/css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo $baseUrl ?? '/permen'; ?>/assets/css/bootstrap-icons.min.css">
<link rel="stylesheet" href="<?php echo $baseUrl ?? '/permen'; ?>/assets/login.css">
</head>
<body>
...
<script src="<?php echo $baseUrl ?? '/permen'; ?>/assets/js/bootstrap.bundle.min.js"></script>
