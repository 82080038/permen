...
// Load materi TKP content
$file = "../content/materi_tkp.php";
...
$pageTitle = 'Materi TKP - Tes Karakteristik Pribadi';
$activePage = 'materi';
?>
<!DOCTYPE html>
<html lang="id">
...
<div class="container" style="max-width: 1200px; margin: 2rem auto; padding: 0 1rem;">
    <div class="card">
        <div class="card-header">
            <h1>💡 Materi Tes Karakteristik Pribadi (TKP)</h1>
            <p>Pelayanan publik, jejaring kerja, sosial budaya, dan profesionalisme</p>
        </div>
        
        <div class="card-body">
            <div class="materi-navigation">
                <a href="materi.php?subtes=TKP" class="btn btn-primary">← Kembali ke Materi</a>
                <div class="subtest-tabs">
                    ...
                    <a href="materi_tkp.php" class="btn btn-primary active">TKP</a>
                </div>
            </div>

            <?php if (empty($materi)): ?>
                <div class="alert alert-warning">
                    <p>📝 Materi TKP sedang dalam pengembangan. Silakan kembali lagi nanti.</p>
                </div>
            <?php else: ?>
