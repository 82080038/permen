-- =====================================================
-- SQL UNTUK HOSTINGER (Tanpa DEFINER, Tanpa VIEW)
-- Database: u950781813_skd_cat_bkn
-- User: u950781813_root
-- =====================================================
...
-- -----------------------------------------------------
-- USERS (Test users dengan password: Sihaloho1982)
-- Password hash untuk 'Sihaloho1982' menggunakan bcrypt
-- -----------------------------------------------------
...
-- Insert test users (password: Sihaloho1982)
-- Hash generated with: password_hash('Sihaloho1982', PASSWORD_DEFAULT)
...
-- -----------------------------------------------------
-- QUESTIONS (Schema only - data import terpisah)
-- -----------------------------------------------------
...
-- CATATAN PENTING:
-- =====================================================
-- 1. File ini HANYA berisi struktur table + data minimal
-- 2. Data soal (2.678 soal) import terpisah via batch
-- 3. Tidak ada VIEW (tidak support di shared hosting)
-- 4. Tidak ada DEFINER clause
-- 5. Password test user: Sihaloho1982
-- =====================================================
