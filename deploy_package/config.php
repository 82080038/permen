...
// Bootstrap the application using modern App class
if (!class_exists('App\Core\App')) {
    error_log('App class not found. Run: composer install');
    die("Application not properly initialized. Please run 'composer install'.");
}
...
// Configure Redis session handler if Redis is available
try {
